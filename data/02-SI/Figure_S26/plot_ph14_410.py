...
data = np.genfromtxt('ph14410.txt', unpack=True).T
...
plt.ylabel('$\mathregular{Emmission \, \, Spectrum \,\, (Excited \, \, at \, \, 410 \,\, nm)}$', labelpad=6,family='Arial')
plt.xlim(450,800)
plt.ylim(0,500)
plt.legend()
plt.show()

fig.savefig('ph14410.tif')
plt.show()