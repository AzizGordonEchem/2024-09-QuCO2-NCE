# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 18:41:57 2023
...
# -*- coding: utf-8 -*-
"""
Created on Tue Jun  6 18:40:29 2023
...
data = np.genfromtxt('ph14575.txt', unpack=True).T
...
plt.ylabel('$\mathregular{Emmission \, \, Spectrum \,\, (Excited \, \, at \, \, 475 \,\, nm)}$', labelpad=6,family='Arial')
plt.xlim(510,800)
plt.ylim(0,500)
plt.legend()
plt.show()

fig.savefig('pH14475.tif')
plt.show()