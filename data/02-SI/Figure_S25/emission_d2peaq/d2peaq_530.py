...
data = np.genfromtxt('d2peaq_530.txt', unpack=True).T
...
plt.ylabel('$\mathregular{Emmission \, \, Spectrum \,\, (Excited \, \, at \, \, 530 \,\, nm)}$', labelpad=6,family='Arial')
plt.xlim(560,800)
plt.ylim(0,3000)

plt.legend()
fig.savefig('d2peaq530.tif')
plt.show()